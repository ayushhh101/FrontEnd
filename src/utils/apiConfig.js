...
const getLocalIP = async () => {
  try {
    ...
    return '10.0.41.172'; // Your current IP
    
  } catch (error) {
    console.log('Could not detect IP, using fallback');
    return '10.0.41.172'; // Fallback to your current IP
  }
};
...
export const API_BASE_URL = 'http://10.0.41.172:3000/api';
...
export const getApiUrl = (endpoint) => {
  const ip = process.env.REACT_NATIVE_API_IP || '10.0.41.172';
